...
# 可以嘗試把 pclass 做 pd.get_dummies(df['pclass'], prefix='pclass')
...
Y_pred_classes = (Y_pred > 0.5).astype(int).reshape(-1)  # -1 代表直接拉成一維數據
print(Y_pred_classes)

ctb = pd.crosstab(Y_test, Y_pred_classes, rownames=['真實'], colnames=['預測'])
print(ctb)